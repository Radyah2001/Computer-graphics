...
function sphere(initialTetrahedron, nSubdivisions) {
    const [a, b, c, d] = initialTetrahedron;
    var vertices = [];
...
function initCubeMap() {
    // Create single-pixel placeholder textures for each cube face
    ...
    // Assign placeholder textures to each face
    ...
    // Load actual textures for each cube face
    var textures = [
